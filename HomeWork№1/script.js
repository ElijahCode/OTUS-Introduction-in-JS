...
console.log(`Sum: ${getSumAndMultiplication(a, b)[0]}, multiplication: ${getSumAndMultiplication(a, b)[1]}`);
...
console.log(`The amount of characters for string's "Hello" and "World" is ${getSumOfStringsLengths(string1, string2)}`);
